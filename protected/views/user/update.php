<div class="pageContent">
	<form method="post" action="<?php echo Yii::app()->createAbsoluteUrl('user/save'); ?>" class="pageForm required-validate" onsubmit="return validateCallback(this, viData);">
		<div class="pageFormContent" layoutH="56">
            ...
            <p>
				<label>Email：</label>
                <input readonly="true" name="email" type="text" class="textInput readonly" size="30" value="<?php echo empty($usrInfo["email"])?"":$usrInfo["email"];?>">
			</p>
            <p>
				<label>姓名：</label>
            ...
            <p>
				<label>GM编号：</label>
				<input name="gm_id" class="textInput" type="text" size="30" value="<?php echo empty($usrInfo["gm_id"])?"":$usrInfo["gm_id"];?>"/>
			</p>
            <p>
				<label>员工编号：</label>
